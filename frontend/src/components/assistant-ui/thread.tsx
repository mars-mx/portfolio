...
const ThreadWelcome: FC = () => {
  ...
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col items-center px-4 text-center">
      ...
      <p className="aui-thread-welcome-hint fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-muted-foreground mt-2 text-sm duration-200">
        {t("welcomeHint")}
      </p>
    </div>
  );
  ...
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      <div
        ...
        className="border-border/60 focus-within:border-border dark:border-muted-foreground/15 dark:focus-within:border-muted-foreground/30 flex w-full flex-col gap-2 rounded-(--composer-radius) border bg-(--composer-bg) p-(--composer-padding) transition-[border-color]"
      >
  ...
  return (
    ...
    >
      ...
      <ActionBarPrimitive.Reload asChild>
        <TooltipIconButton tooltip={t("retry")}>
          <RefreshCwIcon />
        </TooltipIconButton>
  ...
  return (
    ...
    >
      <ActionBarPrimitive.Edit asChild>
        <TooltipIconButton tooltip={t("edit")} className="aui-user-action-edit">
          <PencilIcon />
        </TooltipIconButton>
